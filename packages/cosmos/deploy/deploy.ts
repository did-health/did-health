...
// Configuration
const rpcEndpoint = process.env.RPC_ENDPOINT ?? "https://rpc-testnet.dhealth.dev";
const mnemonic = process.env.MNEMONIC ?? "fantasy rabbit scene want speed document pet dash venture midnight pumpkin order chef payment wrist switch enemy hire fruit lend mushroom obtain burst wrist";
