...
const PatientForm: React.FC = () => {
  ...
  useEffect(() => {
    console.log(practitioner); // This will log the updated organization state after each render
  }, [practitioner]);
  ...
  const handleDIDChange = (
    ...
    setDID((prevDID) => {
      return 'did:health:practitioner:' + value;
    });
  }
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    if (encFile != null) {
      ...
      console.log(cid)
      const uri = "https://" + cid + ".ipfs.w3s.link/Practitioner/" + uuid + "?encHash=" + dataToEncryptHash;
      console.log(uri)
